...
class GuardianModel extends Model
{
    ...
    protected $validationRules = [
        ...
        'relationship' => 'required|min_length[3]|max_length[255]',
    ...
    protected $validationMessages = [
        ...
        'relationship' => [
            'required' => 'O campo de relacionamento é obrigatório.',
            'min_length' => 'O relacionamento deve ter pelo menos 3 caracteres.',
            'max_length' => 'O relacionamento não pode exceder 255 caracteres.',
        ],
        'image' => [
